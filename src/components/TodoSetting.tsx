...
export default function TodoSetting({gameTitle, label, setTodoSettingIsOpen}: {gameTitle?: string, label?: string, setTodoSettingIsOpen?: React.Dispatch<React.SetStateAction<boolean>>}) {
